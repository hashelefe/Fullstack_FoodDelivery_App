...
function RestaurantDetails() {
    ...
    const { fetched: restaurantInfo, isPending: restaurantPending } = useFetch('https://fullstack-food-delivery-server-git-demo-hashelefes-projects.vercel.app/api/restaurants/' + id);
    const { fetched: menu, isPending: menuPending } = useFetch('https://fullstack-food-delivery-server-git-demo-hashelefes-projects.vercel.app/api/restaurants/menus/' + id);
    console.log(menu);
