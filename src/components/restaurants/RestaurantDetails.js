...
<<<<<<< Updated upstream
    const { fetched: restaurantInfo, isPending: restaurantPending } = useFetch('https://fullstackfooddeliveryserver-production.up.railway.app/api/restaurants/' + id);
    const { fetched: menu, isPending: menuPending } = useFetch('https://fullstackfooddeliveryserver-production.up.railway.app/api/restaurants/menus/' + id);
=======
    const { fetched: restaurantInfo, isPending: restaurantPending } = useFetch('https://fooddelivery-api.onrender.com/api/restaurants/' + id);
    const { fetched: menu, isPending: menuPending } = useFetch('https://fooddelivery-api.onrender.com/api/restaurants/menus/' + id);
>>>>>>> Stashed changes
    console.log(menu);
